...
$site = new Site();
$site->addSite('/^(?:(?P<subdomain>[-a-z0-9.]*[-a-z0-9])\.)?(?P<domain>hnsdev|hns-dev|hetnieuwestemmen)\.(?P<tld>(?:nl\.)?gl|(?:nl\.)?devel|(?:nl\.)?accepteproject\.nl|(?:nl\.)?acceptelive\.nl|nl)(?::80)?(?:\/.*)?$/i', 'frontoffice');
