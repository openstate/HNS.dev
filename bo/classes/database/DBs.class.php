...
require_once 'database/MyDatabase.class.php';
require_once 'database/PgDatabase.class.php';
...
class DBs {
	...
	*/
	public static function loadDBInfo() {
		self::$dbinfo = require $_SERVER['DOCUMENT_ROOT'].'/../privates/database.private.php';
	}
}
